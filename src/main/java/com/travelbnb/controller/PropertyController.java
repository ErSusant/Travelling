...
public class PropertyController {
    ...
    public ResponseEntity<PropertyDto>addProperty(
            @RequestParam long countryId, @RequestParam long locationId,@RequestBody PropertyDto propertyDto){
        PropertyDto property1 = propertyIMPL.addProperty(countryId, locationId, propertyDto);
